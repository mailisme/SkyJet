...
class RunAperiodically(private val minIntervalSeconds: Long, private val maxIntervalSeconds: Long, private val task: Runnable) {
    ...
    private fun scheduleNextTask(): Int {
        val timerIndex = Bukkit.getScheduler().scheduleSyncDelayedTask(MinecraftPvpPlugin.instance, run, Random.nextLong(minIntervalSeconds * 20, maxIntervalSeconds * 20))
        return timerIndex
    }
